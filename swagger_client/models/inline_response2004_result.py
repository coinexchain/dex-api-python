...
class InlineResponse2004Result(object):
    ...
    def __init__(self, address=None, coins=None, locked_coins=None, frozen_coins=None, public_key=None,
                 account_number=None, sequence=None, memo_required=None, referee=None,
                 referee_change_time=None):  # noqa: E501
