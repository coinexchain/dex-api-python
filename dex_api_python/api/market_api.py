...
class MarketApi(object):
    ...
    def query_candle_stick(self, market, timespan, time, sid, count, **kwargs):  # noqa: E501
        """Query market candleStick  # noqa: E501

        Query candleStick until to given time  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.query_candle_stick(market, timespan, time, sid, count, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str market: stock/money (required)
        :param str timespan: 1min/1hour/1day (required)
        :param int time: Unix timestamp (required)
        :param int sid: Sequence id (required)
        :param int count: Querier candleStick count limited to 1024 (required)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.query_candle_stick_with_http_info(market, timespan, time, sid, count, **kwargs)  # noqa: E501
        else:
            (data) = self.query_candle_stick_with_http_info(market, timespan, time, sid, count, **kwargs)  # noqa: E501
            return data

    def query_candle_stick_with_http_info(self, market, timespan, time, sid, count, **kwargs):  # noqa: E501
        """Query market candleStick  # noqa: E501

        Query candleStick until to given time  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.query_candle_stick_with_http_info(market, timespan, time, sid, count, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['market', 'timespan', 'time', 'sid', 'count']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method query_candle_stick" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('market' not in params or
            ...
            raise ValueError("Missing the required parameter `market` when calling `query_candle_stick`")  # noqa: E501
        # verify the required parameter 'timespan' is set
        if ('timespan' not in params or
                params['timespan'] is None):
            raise ValueError("Missing the required parameter `timespan` when calling `query_candle_stick`")  # noqa: E501
        # verify the required parameter 'time' is set
        if ('time' not in params or
                params['time'] is None):
            raise ValueError("Missing the required parameter `time` when calling `query_candle_stick`")  # noqa: E501
        # verify the required parameter 'sid' is set
        if ('sid' not in params or
                params['sid'] is None):
            raise ValueError("Missing the required parameter `sid` when calling `query_candle_stick`")  # noqa: E501
        # verify the required parameter 'count' is set
        if ('count' not in params or
                params['count'] is None):
            raise ValueError("Missing the required parameter `count` when calling `query_candle_stick`")  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='list[CandleStick]',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def query_deal(self, market, time, sid, count, **kwargs):  # noqa: E501
        """Query market deal  # noqa: E501

        Query market deal until to given time  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.query_deal(market, time, sid, count, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.query_deal_with_http_info(market, time, sid, count, **kwargs)  # noqa: E501
        else:
            (data) = self.query_deal_with_http_info(market, time, sid, count, **kwargs)  # noqa: E501
            return data

    def query_deal_with_http_info(self, market, time, sid, count, **kwargs):  # noqa: E501
        """Query market deal  # noqa: E501

        Query market deal until to given time  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.query_deal_with_http_info(market, time, sid, count, async_req=True)
        >>> result = thread.get()
        ...
        if ('market' not in params or
                params['market'] is None):
            raise ValueError("Missing the required parameter `market` when calling `query_deal`")  # noqa: E501
        # verify the required parameter 'time' is set
        if ('time' not in params or
                params['time'] is None):
            raise ValueError("Missing the required parameter `time` when calling `query_deal`")  # noqa: E501
        # verify the required parameter 'sid' is set
        if ('sid' not in params or
                params['sid'] is None):
            raise ValueError("Missing the required parameter `sid` when calling `query_deal`")  # noqa: E501
        # verify the required parameter 'count' is set
        if ('count' not in params or
                params['count'] is None):
            raise ValueError("Missing the required parameter `count` when calling `query_deal`")  # noqa: E501
    ...
    def query_depth(self, market, count, **kwargs):  # noqa: E501
        """Query market depth  # noqa: E501

        Query purchases and sales of a market at all price levels  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.query_depth(market, count, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.query_depth_with_http_info(market, count, **kwargs)  # noqa: E501
        else:
            (data) = self.query_depth_with_http_info(market, count, **kwargs)  # noqa: E501
            return data

    def query_depth_with_http_info(self, market, count, **kwargs):  # noqa: E501
        """Query market depth  # noqa: E501

        Query purchases and sales of a market at all price levels  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.query_depth_with_http_info(market, count, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['market', 'count']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if ('market' not in params or
                params['market'] is None):
            raise ValueError("Missing the required parameter `market` when calling `query_depth`")  # noqa: E501
        # verify the required parameter 'count' is set
        if ('count' not in params or
                params['count'] is None):
            raise ValueError("Missing the required parameter `count` when calling `query_depth`")  # noqa: E501
    ...
    def query_order(self, account, time, sid, count, **kwargs):  # noqa: E501
        """Query account's order  # noqa: E501

        Query account's order activities in all markets until to given time  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.query_order(account, time, sid, count, async_req=True)
        >>> result = thread.get()
        ...
        :param int time: Unix timestamp (required)
        :param int sid: Sequence id (required)
        :param int count: Querier order count limited to 1024 (required)
        :param str token: Symbol
        :param str tag: Filter responses type by tag string create/fill/cancel
        :return: UserOrder
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.query_order_with_http_info(account, time, sid, count, **kwargs)  # noqa: E501
        else:
            (data) = self.query_order_with_http_info(account, time, sid, count, **kwargs)  # noqa: E501
            return data

    def query_order_with_http_info(self, account, time, sid, count, **kwargs):  # noqa: E501
        """Query account's order  # noqa: E501

        Query account's order activities in all markets until to given time  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.query_order_with_http_info(account, time, sid, count, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['account', 'time', 'sid', 'count', 'token', 'tag']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if ('account' not in params or
            ...
            raise ValueError("Missing the required parameter `account` when calling `query_order`")  # noqa: E501
        # verify the required parameter 'time' is set
        if ('time' not in params or
                params['time'] is None):
            raise ValueError("Missing the required parameter `time` when calling `query_order`")  # noqa: E501
        # verify the required parameter 'sid' is set
        if ('sid' not in params or
                params['sid'] is None):
            raise ValueError("Missing the required parameter `sid` when calling `query_order`")  # noqa: E501
        # verify the required parameter 'count' is set
        if ('count' not in params or
                params['count'] is None):
            raise ValueError("Missing the required parameter `count` when calling `query_order`")  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='UserOrder',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def query_tickers(self, market_list, **kwargs):  # noqa: E501
        """Query market tickers  # noqa: E501

        Query tickers info  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.query_tickers(market_list, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param list[str] market_list: Market count limited to 1~100 (required)
        :return: list[Tickers]
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.query_tickers_with_http_info(market_list, **kwargs)  # noqa: E501
        else:
            (data) = self.query_tickers_with_http_info(market_list, **kwargs)  # noqa: E501
            return data

    def query_tickers_with_http_info(self, market_list, **kwargs):  # noqa: E501
        """Query market tickers  # noqa: E501

        Query tickers info  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.query_tickers_with_http_info(market_list, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['market_list']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method query_tickers" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'market_list' is set
        if ('market_list' not in params or
                params['market_list'] is None):
            raise ValueError("Missing the required parameter `market_list` when calling `query_tickers`")  # noqa: E501
        ...
        query_params = []
        if 'market_list' in params:
            query_params.append(('market_list', params['market_list']))  # noqa: E501
            collection_formats['market_list'] = 'csv'  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='list[Tickers]',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
